...
TotalTime = 8600     #一共多少秒
tbin = 86000          #时间共多少bin
LeakageRate = 1.0E-9    #Pa*m3/s
LengthX = 0.12      #大约是dr的20倍
LengthY = 0.12
LengthZ = 0.12
dr = 0.0025

LeakPointR = 0.005    #计算开始的位置，漏孔的半径，这里为0.5mm
...
filename = 'Result/OpenBox_5cm.npz'
np.savez(filename,TotalSF6=TotalSF6,SF6IncreaseRate=SF6IncreaseRate,SF6ToTime_1mm=SF6ToTime_1mm,SF6ToTime_2mm=SF6ToTime_2mm,SF6ToTime_5mm=SF6ToTime_5mm,SF6ToTime_1cm=SF6ToTime_1cm,SF6ToTime_2cm=SF6ToTime_2cm,SF6ToTime_5cm=SF6ToTime_5cm,Time=Time)

filename = 'Result/OpenBox_5cm.pdf'
