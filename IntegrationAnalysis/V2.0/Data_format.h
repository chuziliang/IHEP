...
unsigned int get_Edge_Type(char *data)
{
	unsigned int edge_type;
	edge_type = data[0] & 0x20;
	edge_type = edge_type >> 5;
	return edge_type;
}
...
unsigned int get_discri_Evt_counter_per_channel(char *data)
{
	...
	Evt_counter_per_channel_discri_A = Evt_counter_per_channel_discri_A <24;
	Evt_counter_per_channel_discri_B = data[1] & 0xFFu;
	Evt_counter_per_channel_discri_B = Evt_counter_per_channel_discri_B << 16;
	Evt_counter_per_channel_discri_C = data[2] & 0xFFu;
	Evt_counter_per_channel_discri_C = Evt_counter_per_channel_discri_C <<  8;
	Evt_counter_per_channel_discri_D = data[3] & 0x80u;
	//Evt_counter_per_channel_discri_D = data[3] & 0xFFu;
	Evt_counter_per_channel_discri_D = Evt_counter_per_channel_discri_D ;
	...
	Evt_counter_per_channel_discri = Evt_counter_per_channel_discri >> 7;
	//Evt_counter_per_channel_discri = Evt_counter_per_channel_discri;
...
unsigned int get_Trigger_rising_time(char *data)
{
	// Trigger fine falling Time  on 26 bits
	unsigned int Trigger_rising_time_A;
	unsigned int Trigger_rising_time_B;
	unsigned int Trigger_rising_time_C;
	unsigned int Trigger_rising_time_D;
	unsigned int Trigger_rising_time;
	Trigger_rising_time_A = data[0] & 0xFFu;
	Trigger_rising_time_A = Trigger_rising_time_A << 24;
	Trigger_rising_time_B = data[1] & 0xFFu;
	Trigger_rising_time_B = Trigger_rising_time_B << 16 ;
	Trigger_rising_time_C = data[2] & 0xFFu;
	Trigger_rising_time_C = Trigger_rising_time_C << 8 ;
	Trigger_rising_time_D = data[3] & 0xC0u;
	Trigger_rising_time_D = Trigger_rising_time_D  ;
	Trigger_rising_time = Trigger_rising_time_A + Trigger_rising_time_B + Trigger_rising_time_C + Trigger_rising_time_D ;
	Trigger_rising_time = Trigger_rising_time >> 6;
	return Trigger_rising_time;
}
