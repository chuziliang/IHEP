...
int Analysis(int energy, int filenum)
{
    ...
    outputname = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/AllLPMT/Check_12659/ChargeSpectrum/%1dMeVChargeSpectrum.root",energy);
