...
int Analysis(const int energy, const int filenum)
{
    // 打开文件
    TFile *inputfile = NULL;
    TString filename = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/dirac/juno/production/calibration/centos7_amd64_gcc830/Pre-Release/J22.1.0-rc0/Laser/MultiElectron/%1dMeV/detsim/root/detsim-%1d.root",energy,filenum);
    ...
    // 输出文件
    string outputname;
    outputname = "/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/AllLPMT/ChargeSpectrum/"+to_string(energy)+"_MeV/Charge_"+to_string(filenum)+".root";
