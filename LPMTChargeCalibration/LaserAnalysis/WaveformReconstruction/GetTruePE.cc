...
int GetTruePE(int energy, int filenum)
{
    ...
    TFile* outputfile = TFile::Open(TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/WaveformReconstruction/Nonlinearity/%1dMevNonlinearity.root",energy),"UPDATE");
