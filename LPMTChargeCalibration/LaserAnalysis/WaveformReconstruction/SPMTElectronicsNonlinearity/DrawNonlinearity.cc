...
void DrawNonlinearity()
{
    ...
    TGraphErrors *NonlinearityGraph = new TGraphErrors(n,trueCharge,MeanNonlinearity,ErrortrueCharge,ErrorNonlinearity);
    ...
    pad2->cd();
    TGraphErrors *StdDEV = new TGraphErrors(n,trueCharge,RMS,ErrortrueCharge,ErrorRMS);
