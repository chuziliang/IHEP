...
do
    ...
    do
    echo "root -l -q '/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/WaveformReconstruction/SPMTElectronicsNonlinearity/GetTruePE.cc($i,$j)'" >> "job_$m.sh"
    done
    ((m++));
done
