...
void DrawNonUniforimity()
{
    ...
    for (int num = 0; num < 5; num++)
    {
        ...
        for (int PMTID = 0; PMTID < 6; PMTID++)
        {
            ...
            npeLPMTtonpeSPMT[PMTID][num]->SetMarkerStyle(20);
            ...
            ratio[PMTID][num]->SetMarkerStyle(20);
    ...
    for (int PMTID = 0; PMTID < 6; PMTID++)
    {
        ...
        f1[PMTID] = new TF1(TString::Format("f1%1d",PMTID),"[0]*x",0,3);
        

        pad1[PMTID] = new TPad("pad1", "pad1", 0.00, 0.42, 1.00, 0.95);
        pad2[PMTID] = new TPad("pad1", "pad1", 0.00, 0, 1.00, 0.42);
        ...
        f2[PMTID] = new TF1(TString::Format("f2%1d",PMTID),"pol0",0,3);
        ...
        Ratiomg[PMTID]->GetYaxis()->SetRangeUser(10,120);
