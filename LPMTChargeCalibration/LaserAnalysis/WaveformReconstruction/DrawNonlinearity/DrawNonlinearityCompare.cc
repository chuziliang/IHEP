...
void DrawNonlinearityCompare()
{
    ...
    TFile *inputfile_P0 = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/WaveformReconstruction/P0method/npeLPMTtonpeSPMT.root","read");
    TFile *inputfile_nPE = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/WaveformReconstruction/nPEmethod/npeLPMTtonpeSPMT.root","read");
    ...
    for (int i = 0; i < P0_SPMT[0]->GetN(); i++)
    {
        ...
        VectorP0Nonlinearity_total.push_back((totx - toty)/totx);
    ...
    legenda->AddEntry(P0Nonlinearity,"Calibrating nonlinearity with SPMT","lpe");
    legenda->Draw();
