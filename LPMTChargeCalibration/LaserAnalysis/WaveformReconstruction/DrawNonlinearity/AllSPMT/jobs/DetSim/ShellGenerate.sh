...
do
    ...
    do
    echo "root -l -q '/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/WaveformReconstruction/DrawNonlinearity/AllSPMT/GetChargeSpectrumDetsim.cc($i,$j)'" >> "job_$m.sh"
    done
    ((m++));
done
