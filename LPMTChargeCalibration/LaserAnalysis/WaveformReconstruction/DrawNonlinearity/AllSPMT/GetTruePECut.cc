...
int GetTruePECut(int energy, int filenum)
{
    ...
    TFile* outputfile = TFile::Open(TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/WaveformReconstruction/DrawNonlinearity/AllSPMT/ChargeSpectrum/%1dMevCharge.root",energy),"UPDATE");
