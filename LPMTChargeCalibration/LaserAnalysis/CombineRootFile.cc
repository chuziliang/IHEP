...
void CombineRootFile(int i)
{
    ...
    //for (int i = 0; i < 21; i++)
    {
        TFile *rootfile = TFile::Open(TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/LaserAnalysis/ChargeSpectrum/%1dMeVChargeSpectrum.root",energy[i]));
        if (!rootfile)
        {
