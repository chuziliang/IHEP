...
{ 
    TString outputfilename = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/FindNode/ShadowingEffect/DetSimChargeSpectrum/ChargeSpectrum%1d.root",FileID);
    ...
    TString FileName = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/groups/Calibration/chuziliang125/ShadowingEffect/root/detsim_%1d.root",FileID);
