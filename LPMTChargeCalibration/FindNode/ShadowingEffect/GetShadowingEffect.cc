...
void GetShadowingEffect(const int RID, const int ThetaID) {
    // 初始化要用到的PMT参数
    double LPMTQE[17612];
    double SPMTQE[25600];
    ...
    TFile *outputfile = TFile::Open(TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/FindNode/ShadowingEffect/ShadowingEffectHist/R%1d_Theta%1d.root",RID,ThetaID),"recreate");
