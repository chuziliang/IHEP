...
int npeLPMTtonpeSPMT_DetSim_AllPMT(int ChosenType, int CutLevel, int FileId)
{
    ...
    TFile *outputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/FindNode/ShadowingEffect/TestCalibration/results/Cut_"+TString::Format("%1d/",CutLevel)+ChosenTypeString+"/npeLPMTtonpeSPMT_DetSim_AllPMT_"+ChosenTypeString+"_Cut"+TString::Format("%1d",CutLevel)+TString::Format("File_%1d",FileId)+".root","RECREATE");
