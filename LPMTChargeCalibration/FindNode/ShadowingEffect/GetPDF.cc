...
void GetPDF()
{
    ...
    for (int RID = 0; RID < NR; RID++)
    {
        ...
        {
            TString filename = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/FindNode/ShadowingEffect/ShadowingEffectHist/R%1d_Theta%1d.root",RID,ThetaID);
            ...
            CalibFactorHist->SetMinimum(40); // 设置Z轴的下限
            CalibFactorHist->SetMaximum(60); // 设置Z轴的上限
