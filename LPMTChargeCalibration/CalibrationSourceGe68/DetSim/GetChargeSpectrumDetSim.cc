...
int GetChargeSpectrumDetSim(const int foldernum, const int filenum)
{
    ...
    TString outputfilename = "/junofs/users/chuziliang125/LPMTChargeCalibration/CalibrationSourceGe68/DetSim/ChargeSpectrum/" + (TString)line + TString::Format("/ChargeSpectrum%1d.root",filenum);
    ...
    // TString FileName = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/groups/Calibration/chuziliang125/Spallation_neutron/root/detsim_%1d.root",FileID);
    TFile *inputfile = TFile::Open((TString)FileName,"read");
