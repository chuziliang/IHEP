...
double GetNodePosition(Vector3D (&NodePosition)[590]) {
    ...
    TString filename_anchor="/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J22.1.0-rc4/offline/Simulation/DetSimV2/DetSimOptions/data/Strut_Anchor_Acrylic.csv";
...
int npeLPMTtonpeSPMT_DetSim_AllPMT(int ChosenType, int CutLevel, int FileId)
{
    ...
    // TString InputFileName = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/FindNode/ShadowingEffect/DetSimChargeSpectrum/ChargeSpectrum%1d.root",FileId);
    ...
    TString OutputFileName = "/junofs/users/chuziliang125/LPMTChargeCalibration/CalibrationSourceGe68/DetSim/Event_LPMTRelationship/" + (TString)line + ChosenTypeString+"_Cut"+TString::Format("%1d",CutLevel) +".root";
