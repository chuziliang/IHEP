...
int npeLPMTtonpeSPMT_DetSim_AllPMT_merage(int ChosenType, int CutLevel)
{
    ...
    {
        getline(file, line);
        TString InputName = "/junofs/users/chuziliang125/LPMTChargeCalibration/CalibrationSourceGe68/DetSim/Event_LPMTRelationship/" + (TString)line + ChosenTypeString+"_Cut"+TString::Format("%1d",CutLevel) +".root";
