...
void GetShadowingEffect_NoBar(const int RID, const int ThetaID) {
    ...
    TFile *inputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/REffect/OldOpticalModel/ChargeSpectrum.root","read");
    ...
    TFile *outputfile = TFile::Open(TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/REffect/OldOpticalModel/ShadowingEffect/R%1d_Theta%1d.root",RID,ThetaID),"recreate");
