...
{ 
    ...
    TString FileName = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/groups/Calibration/chuziliang125/REffect/NoBar/PMT_11042/%.1f/root/detsim_%1d.root",Position_ID,FileID);
    TFile *inputfile = TFile::Open(FileName,"read");
    if (!inputfile) return 0;
    
    TString outputfilename = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/REffect/OnlyLS/OnePMT_11042/ChargeSpectrum/%.1f/ChargeSpectrum%1d.root",Position_ID,FileID);
