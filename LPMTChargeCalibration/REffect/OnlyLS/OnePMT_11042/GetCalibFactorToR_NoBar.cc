...
int GetCalibFactorToR_NoBar()
{
    ...
    {
        TString inputname = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/REffect/OnlyLS/OnePMT_11042/ChargeSpectrum/ChargeSpectrum_%.1f.root",EvtPosition[RID]);
