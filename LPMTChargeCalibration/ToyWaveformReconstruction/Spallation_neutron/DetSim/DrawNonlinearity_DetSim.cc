...
{
    TFile *inputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Spallation_neutron/DetSim/results/npeLPMTtonpeSPMT_DetSim_AllPMT_NNVT_Cut2.root","read");
