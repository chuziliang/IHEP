...
int npeLPMTtonpeSPMT_DetSim_AllPMT(int ChosenType, int CutLevel)
{
    ...
    TFile *outputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Spallation_neutron/DetSim/results/npeLPMTtonpeSPMT_DetSim_AllPMT_"+ChosenTypeString+"_Cut"+TString::Format("%1d",CutLevel)+".root","RECREATE");
