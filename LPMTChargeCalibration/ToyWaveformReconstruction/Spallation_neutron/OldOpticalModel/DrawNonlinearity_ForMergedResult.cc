...
void DrawNonlinearity_ForMergedResult(int ChosenType)
{
    ...
    TString InputName = "/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Spallation_neutron/OldOpticalModel/MeragedResult/npeLPMTtonpeSPMT_B12_DetSim_AllPMT_"+ChosenTypeString+"_Cut"+TString::Format("%1d",4)+".root";
    ...
    legenda->Draw("same");
    TString OutputName = "/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Spallation_neutron/OldOpticalModel/MeragedResult/Graph_"+ChosenTypeString+"_Cut"+TString::Format("%1d",4)+".root";
