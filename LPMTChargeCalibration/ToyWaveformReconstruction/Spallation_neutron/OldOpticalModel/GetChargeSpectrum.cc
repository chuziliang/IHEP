...
{ 
    TString outputfilename = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Spallation_neutron/OldOpticalModel/ChargeSpectrum/ChargeSpectrum%1d.root",FileID);
    ...
    TString CalibFileName = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/groups/Calibration/chuziliang125/Spallation_neutron/OldOpticalModel/Calib/root/cailb-%1d.root",FileID);
    TString ElecFileName  = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/groups/Calibration/chuziliang125/Spallation_neutron/OldOpticalModel/Elec/user/elec-%1d.root",FileID);
