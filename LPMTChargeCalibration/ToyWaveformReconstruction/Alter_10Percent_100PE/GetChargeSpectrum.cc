...
int GetChargeSpectrum(int energy, int filenum)
{
    ...
    TFile* outputfile = TFile::Open(TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE/ChargeSpectrum/TotalPE/%1dMevCharge.root",energy),"UPDATE");
    ...
    charge->Branch("TrueChargeLPMT",&TrueChargeLPMT,"TrueChargeLPMT/D");
