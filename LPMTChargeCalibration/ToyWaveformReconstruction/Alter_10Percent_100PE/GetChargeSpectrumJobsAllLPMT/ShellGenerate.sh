...
do
    ...
    do
    echo "root -l -q '/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE/GetChargeSpectrum_AllLPMT.cc($i,$j)'" >> "job_$m.sh"
    done
    ((m++));
done
