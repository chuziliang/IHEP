...
int npeLPMTtonpeSPMT_c()
{
    ...
    cout<<"CorrespondingSPMT[LPMTID][0] = "<<CorrespondingSPMT[LPMTID][0]<<endl;
    cout<<"CorrespondingSPMT[LPMTID][1] = "<<CorrespondingSPMT[LPMTID][1]<<endl;
    cout<<"CorrespondingSPMT[LPMTID][2] = "<<CorrespondingSPMT[LPMTID][2]<<endl;
    cout<<"CorrespondingSPMT[LPMTID][3] = "<<CorrespondingSPMT[LPMTID][3]<<endl;
    cout<<"CorrespondingSPMT[LPMTID][4] = "<<CorrespondingSPMT[LPMTID][4]<<endl;
    cout<<"CorrespondingSPMT[LPMTID][5] = "<<CorrespondingSPMT[LPMTID][5]<<endl;
    ...
    for (int i = 0; i < 21; i++)
    {
        ...
        for (int j = 0; j < numbers[i]; j++) // 每个能量下的文件
        {
            ...
            for (int k = 0; (k < LPMT_charge->GetEntries()) && (k < SPMT_charge->GetEntries()); k++)
            {
        ...
        cout<<i<<" Finished. Total Events: "<<TotalEntries<<endl;
    }
    TFile *outputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE/npeLPMTtonpeSPMT_c.root","RECREATE");
