...
{
    TFile *inputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12_OldOpticalModel/result/npeLPMTtonpeSPMT_B12_DetSim_AllPMT_HighQENNVT_Cut4.root","read");
