...
int npeLPMTtonpeSPMT_B12_DetSim_AllPMT(int ChosenType, int CutLevel)
{
    int MinFile = 0;
    int MaxFile = 20;
    ...
    {
        TString InputFileName = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12_OldOpticalModel/ChargeSpectrum/ChargeSpectrum%1d.root",FileId);
    ...
    TFile *outputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12_OldOpticalModel/result/npeLPMTtonpeSPMT_B12_DetSim_AllPMT_"+ChosenTypeString+"_Cut"+TString::Format("%1d",CutLevel)+".root","RECREATE");
