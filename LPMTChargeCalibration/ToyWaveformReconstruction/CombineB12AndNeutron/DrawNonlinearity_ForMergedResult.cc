...
void DrawNonlinearity_ForMergedResult(int ChosenType)
{
    ...
    TString InputName = "/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/CombineB12AndNeutron/result/Combine_B12_Neutron_"+ChosenTypeString+"_Cut"+TString::Format("%1d",4)+".root";
    ...
    legenda->Draw("same");
    TString OutputName = "/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/CombineB12AndNeutron/result/Graph_"+ChosenTypeString+"_Cut"+TString::Format("%1d",4)+".root";
