...
int npeLPMTtonpeSPMT_B12_DetSim_AllPMT(int ChosenType, int CutLevel, int files)
{
    int MinFile;
    int MaxFile;
    if (files==0)
    ...
    {
        TString InputFileName = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12/DetSimChargeSpectrum/ChargeSpectrum%1d.root",FileId);
    ...
    TFile *outputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12/results/DetSim/npeLPMTtonpeSPMT_B12_DetSim_AllPMT_"+ChosenTypeString+"_Cut"+TString::Format("%1d",CutLevel)+"_File"+TString::Format("%1d",files)+".root","RECREATE");
