...
{
    TFile *inputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12/results/DetSim/npeLPMTtonpeSPMT_B12_DetSim_AllPMT_HighQENNVT_Cut3_File1.root","read");
    ...
    TF1 *Below1PE = new TF1("Below1PE","[0]*x",0,10);
