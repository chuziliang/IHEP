...
{ 
    TString outputfilename = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12/NoSticksTest/ChargeSpectrum/ChargeSpectrum%1d.root",FileID);
    ...
    TString FileName = TString::Format("root://junoeos01.ihep.ac.cn//eos/juno/groups/Calibration/chuziliang125/B12/DisableSticks/root/detsim_%1d.root",FileID);
