...
{
    TFile *inputfile = TFile::Open("/junofs/users/chuziliang125/LPMTChargeCalibration/ToyWaveformReconstruction/Alter_10Percent_100PE_B12/npeLPMTtonpeSPMT_B12_test.root","read");
    TGraphErrors *npeLPMTtonpeSPMT_tot;
    TString GraphName = "20/LPMT #mu to SPMT #mu";
    ...
    TString GraphName_True = "20/True LPMT #mu to SPMT #mu";
