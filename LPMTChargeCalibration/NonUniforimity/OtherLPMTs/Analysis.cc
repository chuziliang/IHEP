...
int Analysis(const int foldernum, const int filenum, const int LPMT_ID)
{
    ...
    string outputname;
    outputname = "/junofs/users/chuziliang125/LPMTChargeCalibration/NonUniforimity/OtherLPMTs/ChargeSpectrum/"+to_string(LPMT_ID)+"/" + line + "/ChargeSpectrum_"+to_string(filenum)+".root";
