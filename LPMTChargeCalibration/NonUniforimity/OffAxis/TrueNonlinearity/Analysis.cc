...
int Analysis(int energy, int filenum, const int LPMT_ID)
{
    ...
    outputname = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/NonUniforimity/OffAxis/TrueNonlinearity/ChargeSpectrum/%1dMeVChargeSpectrum.root",energy);
