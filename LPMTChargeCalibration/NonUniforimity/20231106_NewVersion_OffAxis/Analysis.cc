...
int Analysis(const int foldernum, const int filenum, const int LPMT_ID)
{
    ...
    string outputname;
    outputname = "/junofs/users/chuziliang125/LPMTChargeCalibration/NonUniforimity/20231106_NewVersion_OffAxis/ChargeSpectrum/" + line + "/ChargeSpectrum_"+to_string(filenum)+".root";
