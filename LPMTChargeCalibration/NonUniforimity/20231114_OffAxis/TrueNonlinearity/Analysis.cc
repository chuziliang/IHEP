...
int Analysis(int energy, int filenum, const int LPMT_ID)
{
    ...
    outputname = TString::Format("/junofs/users/chuziliang125/LPMTChargeCalibration/NonUniforimity/20231114_OffAxis/TrueNonlinearity/ChargeSpectrum/%1dMeVChargeSpectrum.root",energy);
