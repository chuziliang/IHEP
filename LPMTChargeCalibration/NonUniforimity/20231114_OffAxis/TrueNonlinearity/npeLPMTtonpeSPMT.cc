...
void npeLPMTtonpeSPMT()
{
    ...
    TFile *output = new TFile("/junofs/users/chuziliang125/LPMTChargeCalibration/NonUniforimity/20231114_OffAxis/TrueNonlinearity/npeLPMTtonpeSPMTroot/npeLPMTtonpeSPMT.root","RECREATE");
