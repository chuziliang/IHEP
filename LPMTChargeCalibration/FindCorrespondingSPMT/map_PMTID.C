void map_PMTID()
  ...
  TString filename_LPMT="/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc1120/Pre-Release/J23.1.0-rc0/data/Detector/Geometry/PMTPos_CD_LPMT.csv";
  inputfile_LPMT.open(filename_LPMT,ios::in);
  if(!inputfile_LPMT.good()) {cout<<"error"<<endl;return 0;}
  ifstream inputfile_SPMT;
  TString filename_SPMT="/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc1120/Pre-Release/J23.1.0-rc0/data/Detector/Geometry/PMTPos_CD_SPMT.csv";
