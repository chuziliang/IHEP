...
int main(int argc,char** argv) {
    ...
    cout<<fileNum<<"\t"<<i<<" "<<runName[fileNum-1]<<endl;
        ...
        ofstream FitPedestalResult;
        FitPedestalResult.open("FitPedestalResult.txt",ios::app);
        FitPedestalResult<<fileNum<<"\t"<<i<<" "<<runName[fileNum-1]<<endl;
    ...
    for (int lpFile=0; lpFile<fileNum; lpFile++) {
        ...
        FitPedestalResult<<endl;
        FitPedestalResult.close();
