    ...
    for (int Chn = 0; Chn < 128; Chn++)
    {
        ...
        for (int entry = FirstEntry+1; entry < DataTree->GetEntries(); entry++)
        {
            ...
            if (channelNumber == Chn)
            {
                ...
                // if (entry%1000 == 0)
                // {
                //     cout<<coarseTimeOverflow<<endl;
                // }
                
                if (test )
                {
                    cout<<"CoarseTimeAfterOverFlow "<<LastCoarseTime<<endl;
                    test = false;
                }
                
                if (LastCoarseTimeOverflow != coarseTimeOverflow)
                {
                    cout<<"Channel "<<Chn<<endl;
                    cout<<"Entry "<<entry<<endl;
                    cout<<"CoarseTime "<<LastCoarseTime<<endl;
                    cout<<"CoarseTimeOverFlow "<<coarseTimeOverflow<<endl;
                    test = true;
                    // break;
                }
