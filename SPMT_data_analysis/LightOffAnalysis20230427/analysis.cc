...
string FilePath = "/junofs/users/chuziliang125/LightOffAnalysis20230427/binary/";
...
int main(int argc,char** argv) {
    ...
    if( argc != 3 ) {
        ...
        std::cerr << "USAGE: ./main datalist.txt file_number" << std::endl;
        return 1;
    }
    ...
    //for(int fileNum = 0; fileNum<TotFileNum; fileNum++)
    {
        ...
        ResultPathROOT = "/junofs/users/chuziliang125/LightOffAnalysis20230427/Result/ROOT/";
        ResultPathPDF = "/junofs/users/chuziliang125/LightOffAnalysis20230427/Result/pdf/";
        ...
        TFile *ChargePingAll = new TFile("/junofs/users/chuziliang125/LightOffAnalysis20230427/Result/ChargePingAllRun.root","UPDATE");
