void Charge2SSHDACuSimcopy()
{
	...
	TH2 *Charge2DACu = new TH2D("Charge-SSH","Charge-SSH",1000,0,2.0,1000,0.0,2.0); 
	...
	for ( Int_t cyc = 0; cyc<10000; cyc++){
		...
		for (int i = 0; i<n; i++)
		{
			...
			{
				ChargeSSH = (hbSSH->GetBinContent(i+27))*0.3854+78.59//*0.3839+57.36;
	...
	TF1* fitfunc = new TF1("f1","[0]*x+[1]",0,2.0);
